...
public class ExamplePoorAdditionExpressionImpl extends ASTWrapperPsiElement implements ExamplePoorAdditionExpression {

  public ExamplePoorAdditionExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ExampleVisitor visitor) {
    visitor.visitPoorAdditionExpression(this);
  }
  ...
  public ExamplePoorAdditionExpression getPoorAdditionExpression() {
    return findChildByClass(ExamplePoorAdditionExpression.class);
  }
