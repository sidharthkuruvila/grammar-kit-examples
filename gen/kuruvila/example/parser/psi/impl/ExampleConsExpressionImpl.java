...
public class ExampleConsExpressionImpl extends ExampleRecursiveExpressionImpl implements ExampleConsExpression {

  public ExampleConsExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ExampleVisitor visitor) {
    visitor.visitConsExpression(this);
  }
